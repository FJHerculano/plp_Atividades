// projeto antigo, feito através de video aula 
// mas como prototipo em java ta certinho !!!
// alguns bugs, mas o prototipo do que se pede tem 
package javafx.mvc;
...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws IOException {
        ...
        primaryStage.setTitle("Login simples");
        primaryStage.show();
